...
// 3. Join all pages to single array (we're doing this in memory 'cause fuck it)

// 4. Identify where everything begins
// 5. identify where everything ends
// 6. combine rogue multiline rows into normal single rows
// I think the rule for this is that each new line begins when there is an entry in the 'balance' column
